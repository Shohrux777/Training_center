      ...
      <table  class="myTable mt-3">
        ...
        <tr class="header ">
            ...
            <th v-for="column in datasource.columns" :key="column">{{$t(column)}} 
              <span style="position:relative;" @click="upFunc(column)">
                <mdb-icon icon="angle-up" class="px-1 up_down_icon"  style="position:absolute; top:-2px; cursor:pointer;"/> 
                <mdb-icon icon="angle-down" class="px-1 up_down_icon" style="position:absolute; bottom:-4px; cursor:pointer;"/>
              </span>
            </th>
